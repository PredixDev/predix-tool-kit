...
var styleTask = function (stylesPath, srcs) {
  return gulp.src(srcs.map(function(src) {
    ...
    .pipe($.cssmin())
    .pipe(gulp.dest('dist/www/' + stylesPath))
...
gulp.task('copy', function () {
  ...
  var bower = gulp.src([
    'bower_components/**/*'
]).pipe(gulp.dest('dist/www/bower_components'));
  ...
  var swToolbox = gulp.src(['bower_components/sw-toolbox/*.js'])
    .pipe(gulp.dest('dist/www/sw-toolbox'));

  var vulcanized = gulp.src(['app/elements/elements.html'])
    .pipe($.rename('elements.vulcanized.html'))
    .pipe(gulp.dest('dist/www/elements'));

  var server = gulp.src(['server/*'])
...
gulp.task('vulcanize', function () {
  return gulp.src('dist/www/index.html')
...
gulp.task('rename-index', function () {
  return gulp.src('dist/www/index.build.html')
    .pipe($.rename('index.html'))
    .pipe(gulp.dest('dist/www/'));
});

gulp.task('remove-old-build-index', function () {
  return del('dist/www/index.build.html');
});
